...
import githubLight from '../../assets/icons/github-icon-light.svg'

import fiverrDark from '../../assets/icons/fiverr-icon-dark.svg'
import fiverrLight from '../../assets/icons/fiverr-icon-light.svg'

import emailDark from '../../assets/icons/fiverr-icon-dark.svg'
import emailLight from '../../assets/icons/fiverr-icon-light.svg'
